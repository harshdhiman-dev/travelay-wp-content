...
<div class="c-block<?php echo esc_attr( $className ); ?>" style="<?php echo $styles; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
	<div class="c-block__text<?php echo esc_attr( $classNameTextComponent ); ?>" style="<?php echo esc_attr( $stylesTextComponent ); ?>">

        <InnerBlocks className="c-block__inner"
