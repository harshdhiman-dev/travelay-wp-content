...
$extra_attributes = ds_theme_generate_extra_atts(
	array_merge(
		$attributes,
		array(
			'class' => 'dst-accordion__item ' . $exsisting_classes,
		)
	),
	$block
);
...
<details <?php echo get_block_wrapper_attributes( $extra_attributes ); // phpcs:ignore ?>>
	<?php if ( $block_title ) : ?>
		<summary class="dst-accordion__title">
			<span>
				<?php echo wp_kses_post( $block_title ); ?>
			</span>
		</summary>
	<?php endif; ?>
	<div class="dst-accordion__content">
		<?php
		/*
