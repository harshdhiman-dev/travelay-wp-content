...
<?php do_action( 'wp_body_open' ); ?>
	...
	<a class="skip-link screen-reader-text" href="#wp--skip-link--target"><?php esc_html_e( 'Skip to content', 'dstheme' ); ?></a>
<?php
$global_background_image = get_field( 'global_background_image', 'options' );
$show_background = is_archive() || is_home() || is_single() || is_page_template( 'templates/template-simple-text.php' );
$wrapper_styles = '';
?>
<?php
...
<div class="wrapper <?php echo $show_background && $global_background_image ? ' -has-global-img' : ''; ?>" data-sticky="<?php echo esc_attr( $dsmp_settings->header_sticky_type ); ?>"
