(function(global, factory) {
    ...
    function stopAnimation(data) {
        ...
        /**
         * DS_EDIT_STARTS
         * DS_NOTE: The following snippet was added to toggle the appearance
         * of the playback button (animate/pause)
         */
        var parentWrap = data.target.closest('.m-image-spinner');

        if (0 < parentWrap.length) {
            parentWrap.removeClass('is-playing');
        }
        /**
         * DS_EDIT_ENDS
         */
        ...
        /**
         * DS_EDIT_STARTS
         * DS_NOTE: Trigger custom event here. Other related events will fire on each frame update.
         */
        data.target.trigger('onAnimationStop.' + namespace, data);
        /**
         * DS_EDIT_ENDS
         */
    }
    ...
    extendApi({
        ...
        playTo: function(frame, options) {
            ...
            /**
             * DS_EDIT_STARTS
             * DS_NOTE: The following snippet was modified to speed up the animation
             * when navigating between the hotspots (prev/next)
             */
            // applyAnimation(data);

            var dataFrameTime = data.frameTime;
            data.frameTime = data.playToFrameTime;

            applyAnimation(data);

            // assign chosen frameTime back to spinner options:
            data.frameTime = dataFrameTime;
            /**
             * DS_EDIT_ENDS
             */
    ...
    (function() {
        ...
        function onDraw(e, data) {
            ...
            if (data.renderer === 'canvas') {
                ...
                /**
                 * DS_EDIT_STARTS
                 * DS_NOTE: The following line was edited due to a bug with image resizing.
                 */
                //   data.context.drawImage(image, sprite.sampledX, sprite.sampledY, sprite.sampledWidth, sprite.sampledHeight, 0, 0, w, h);
                data.context.drawImage(image, 0, 0, w, h);
                /**
                 * DS_EDIT_ENDS
                 */
                return;
    ...
    (function() {
        ...
        function onClick(e, data) {
            ...
            /**
             * DS_EDIT_STARTS
             * DS_NOTE: Prevent zoom trigger on mouse click
             */
            /*
            if (toggleZoom(data)) {
        ...
        registerPlugin(NAME, {
            ...
            /**
             * DS_EDIT_STARTS
             * DS_NOTE: Prevent frame changing on mouse move, when zoom is active
             */
            //    mousemove: onMove,
            //   touchmove: onMove,
            /**
